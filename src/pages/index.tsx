  ...
  return (
    <Layout>
      ...
      <main className="text-black">
        <div className="flex-col h-screen items-center justify-center bg-indigo-50 px-4">
          <div className="mx-auto mb-5 max-w-sm flex-col rounded-3xl border-4 border-t-8 border-gray-900 bg-white  py-6 text-black shadow-2xl">
