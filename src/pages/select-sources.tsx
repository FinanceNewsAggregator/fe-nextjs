...
import { faEnvelopeCircleCheck, faGlobe } from "@fortawesome/free-solid-svg-icons";
  ...
  return <div className=" group py-10 bg-gray-100  max-w-sm flex justify-center items-center  mx-auto ">
    <div className="flex-col w-full max-w-sm items-center justify-center bg-white p-8 rounded shadow px-4">
      ...
      <div class="p-5">
        ...
        <button class="w-full rounded-md bg-black  py-2 text-indigo-100 hover:bg-indigo-500 hover:shadow-md duration-75">Next</button>
      </div>
