  ...
  return <div className=" group py-10 bg-gray-100  max-w-sm flex justify-center items-center  mx-auto ">
    <div className="flex-col w-full max-w-sm items-center justify-center bg-white p-8 rounded shadow px-4">
      ...
      <div className="p-5">
        ...
        <label for="toggle" class="text-xs text-gray-700"> <span className="text-black">News York Times </span> </label>
      </div>
      <div className="p-5">
        <div class="relative inline-block w-10 mr-2 align-middle select-none transition duration-200 ease-in">
          <input type="checkbox" name="toggle" id="toggle" class="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none cursor-pointer" />
        ...
        <label for="toggle" class="text-xs text-gray-700">
          <span className="text-black"> Tech Crunch</span> </label>
      </div>
      <div className="p-5">
        <div class="relative inline-block w-10 mr-2 align-middle select-none transition duration-200 ease-in">
          <input type="checkbox" name="toggle" id="toggle" class="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none cursor-pointer" />
        ...
        <label for="toggle" class="text-xs text-gray-700">
          <span className="text-black">CNBC</span> </label>
      </div>
      <div className="p-5">
        <div class="relative inline-block w-10 mr-2 align-middle select-none transition duration-200 ease-in">
          <input type="checkbox" name="toggle" id="toggle" class="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none cursor-pointer" />
        ...
        <label for="toggle" class="text-xs text-gray-700">
          <span className="text-black">Bloomberg</span> </label>
      </div>
      <div className="p-5">
        <div class="relative inline-block w-10 mr-2 align-middle select-none transition duration-200 ease-in">
          <input type="checkbox" name="toggle" id="toggle" class="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none cursor-pointer" />
        ...
        <label for="toggle" class="text-xs text-gray-700">
          <span className="text-black"> Reuters</span> </label>
      </div>
      <hr />
